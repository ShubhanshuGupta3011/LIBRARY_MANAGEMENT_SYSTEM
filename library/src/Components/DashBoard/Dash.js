...
export default function Dash() {
  ...
  return (
    ...
    <div style={{backgroundColor:'beige',height:570,width:1260}} >
        ...
        <div> <button type="button" class="btn btn-success mx-3 my-3" style={{width:150,height:96}} onClick={()=>{navigate("/Issue")}}>  Issue_book  </button>     </div> 
        <div> <button type="button" class="btn btn-info mx-3 my-3" style={{width:150,height:96}} onClick={()=>{navigate("/Return")}}>  Return_book  </button>     </div> 
